...
class OpenLDBWS
{
    ...
    function __construct($accessToken, $trace = false)
    {
        ...
        $soapOptions = ["trace" => $this->trace, "compression" => SOAP_COMPRESSION_ACCEPT | SOAP_COMPRESSION_GZIP];

        $this->soapClient = new SoapClient("https://lite.realtime.nationalrail.co.uk/OpenLDBWS/wsdl.aspx?ver=2016-02-16", $soapOptions);

        $soapVar = new SoapVar(["ns2:TokenValue" => $this->accessToken], SOAP_ENC_OBJECT);
